...
<div class="judul-dok">
    ...
    <div class="periode">
        @if(!empty($filterInfo)) {{ implode(' &nbsp;|&nbsp; ', $filterInfo) }}
        @else Seluruh Data s/d {{ now()->format('d F Y') }} @endif
    </div>
</div>
...
<div class="info-box">
    <table class="info-tbl">
        <tr>
            <td class="lbl">Dicetak Oleh</td><td>: {{ $dicetak_oleh }}</td>
        ...
        <tr>
            ...
            <td></td>
            <td class="lbl">Sistem</td><td>: BatusangkarLapor v1.0</td>
        </tr>
    </table>
</div>
...
<div class="stats-wrap">
    <table>
        <thead>
            <tr>
                <th>Total Laporan</th><th>Belum Ditindak</th><th>Sedang Ditindak</th>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width:19%">Judul Laporan</th>
...
{{-- ══ PENUTUP ══ --}}
<div class="penutup">
    <p>Demikian rekapitulasi laporan pengaduan masyarakat ini dibuat untuk dipergunakan sebagaimana mestinya.</p>
</div>
...
<div class="ttd-wrap">
    <div class="ttd-box">
        ...
        <p class="ttd-jabatan">Administrator Sistem</p>
